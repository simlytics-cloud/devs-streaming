...
@NullMarked
@Value.Immutable
@JsonSerialize(as = NextInternalTimeReport.class)
@JsonDeserialize(as = NextInternalTimeReport.class)
public abstract class AbstractNextInternalTimeReport<T extends SimTime> extends DevsSimMessage implements
    TimedMessage<T>, HasPayload<AbstractModelIdPayload> {

  @Override
  public SimMessageType getMessageType() {
    return SimMessageType.NextInternalTimeReport;
  }
