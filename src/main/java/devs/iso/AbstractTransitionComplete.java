...
@NullMarked
@Value.Immutable
@JsonSerialize(as = TransitionComplete.class)
@JsonDeserialize(as = TransitionComplete.class)
public abstract class AbstractTransitionComplete<T extends SimTime> extends DevsSimMessage implements
    TimedMessage<T> {

  @Override
  public SimMessageType getMessageType() {
    return SimMessageType.TransitionComplete;
  }
