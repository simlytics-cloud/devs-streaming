...
/**
 * An subsequent message sent to inform external models of the updated state of an object.
 * The state object of type T will have only the changed fields set.
