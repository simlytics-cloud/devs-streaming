...
public interface SimState<T> {
   ...
   * @param stateUpdate this object will only have the fields that have changed since the
   *                    previous update set.
   * @return a new object of type T whose fields have been updated based on the values in the
   *     state update.
   */
