...
/**
 * An initial message sent to inform external models of the initial state of an object.
 * The state object of type T will have all of its fields set.
...
public abstract class AbstractSimStateInitialized<T extends SimState<T>> implements
    SimStateMessage<T> {
