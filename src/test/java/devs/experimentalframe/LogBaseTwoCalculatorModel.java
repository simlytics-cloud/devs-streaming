...
public class LogBaseTwoCalculatorModel extends ScheduledDevsModel<LongSimTime, Void> {
	...
	public static final Port<Integer> numberIn = new Port<Integer>("numberIn");
	public static final Port<String> wordIn = new Port<String>("wordIn");
	public static final Port<Integer> numberOut = new Port<Integer>("numberOut");
	public static final Port<String> wordOut = new Port<String>("wordOut");
