...
public class PendingOutputSimulationTest {
  ...
  void parallelDevsSimulationTest() throws InterruptedException {
    ...
    ActorRef<DevsMessage> generatorSim = testKit.spawn(PDevsSimulator.create(
            new ScheduledGeneratorModel(0, generatorName), LongSimTime.builder().t(0L).build()));
    ...
    ActorRef<DevsMessage> rootCoordinator =
        testKit.spawn(RootCoordinator.create(LongSimTime.builder().t(2L).build(), coordinator, "genStoreCoupled"));
